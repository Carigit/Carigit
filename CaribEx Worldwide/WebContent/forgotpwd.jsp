...
<body>
<form name="login" id="f1" method="post" action="forgotpwdaction.jsp" onsubmit="return validate()" >
<div id="rcorners2">
<p><b><font face="Helvetica Neue" color="#4F4464" size="5">Forgot your Password?</font></b></p>
...
<td id="text"><input type="text" class="rounded" name="un" size="20" /></td>
</tr>
<tr><td></td><td></td></tr>
<tr><td></td><td></td></tr>
</table>
